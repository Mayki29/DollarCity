...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="nav-link menu_item menu_link shadow-sm"><i class="fas fa-download "></i> Generate Report</a>
    </div>
...
<!-- DEMO -->
<script src="<?=$url_host?>assets/js/demo-chart/Chart.min.js"></script>
<script src="<?=$url_host?>assets/js/demo-chart/chart-area-demo.js"></script>
<script src="<?=$url_host?>assets/js/demo-chart/chart-pie-demo.js"></script>
