                    ...
                    <div>
                        ...
                        <div class="card shadow mb-5">
                            <div class="card-header py-3">
                                <h5 class="m-0 font-weight-bold text-primary">Ventas</h5>
                                <br>
                                     ...
                                     <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control bg-emphasis border-1 small"  placeholder="Buscar..." aria-label="Example text with button addon" aria-describedby="button-addon1">
                                      </div>
                                    ...
                                    <table  class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody class="table-hover">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group"> 
                                                        <button class="btn btn-outline-success" type="button" data-toggle="modal" data-target="#exampleModal">
                                    ...
                                    <form>
                                        ...
                                        <table  >
                                            <tr>
                                                <fieldset disabled>
                                                    <div class="form-group">
                                                      ...
                                                      <input type="text" id="disabledTextInput" class="form-control" placeholder="Empleado1">
                                                    </div>
                                         ...
                                         <table>
                                            ...
                                            <div class="form-control productosSeleccionados" style="max-height: 150px; overflow-y: auto;"></div>
                                         ...
                                         <table>
                                            <tr>
                                                ...
                                                <td> <input type="text" class="form-control" name="subtotal"
                                                        placeholder="0.0" id="subtotal"></td>
                                            </tr>
                                            <tr>
                                                <td><hr></td>
                                                <td><hr></td>
                                            ...
                                            <tr >
                                                      ...
                                                      <td><input type="text" id="disabledTextInput" class="form-control" placeholder="0.0" disabled></td>
                                            </tr>
                            ...
                            <div class="modal-body">
                              ...
                              <form>
                                ...
                                <table>
                                    <tr>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="empleado" placeholder="Empleado1">
                                        </div>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="datetime-local" class="form-control" id="fecha" name="fecha" placeholder="Fecha..."></td>
                                    </tr>
                                ...
                                <table>
                                    <tr>
                                        <td><label for="subtotal">Subtotal: </label></td>
                                        <td><input type="text" class="form-control" name="subtotal" placeholder="0.0" id="subtotal"></td>
                                    </tr>
                                    <tr>
                                        <td><hr></td>
                                        <td><hr></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" name="total" placeholder="0.0" id="total"></td>
                                    </tr>
                                </table>
